...
export const getPosts = (req, res) => {
  ...
  jwt.verify(token, "secretkey", (err, userInfo) => {
    ...
    const q =
      "SELECT p.*, u.name, u.profilePic FROM posts p LEFT JOIN relationships r ON p.userId = r.followedUserId JOIN users u ON p.userId = u.id WHERE r.followerUserId = ? OR p.userId = ? ORDER BY p.createdAt DESC"
